...
class minintCompare {
public:
	static bool prior(int x, int y) { comparisons++; return x < y; }  
};
...
public:
  static bool lt(int x, int y) { comparisons++; return x < y; }
  static bool eq(int x, int y) { comparisons++; return x == y; }
  static bool gt(int x, int y) { comparisons++; return x > y; }
};
